...
while [ true ]; do
	gst-launch-1.0 -qe tcpclientsrc blocksize=16384 host=192.168.2.208 port=5002 do-timestamp=true !\
		...
		matroskamux ! tcpclientsink blocksize=16384 host=localhost port=10000
